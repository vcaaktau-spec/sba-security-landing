...
export const Cta = () => {
  ...
  return (
    <>
      ...
      {/* ИСПРАВЛЕНИЕ: ВЫНОСИМ МОДАЛКУ В ПОРТАЛ НА УРОВЕНЬ BODY */}
            ...
            <div className="fixed inset-0 z-[10000] flex justify-end text-foreground overflow-hidden">
              ...
              >
                ...
                <div className="flex-shrink-0 relative z-30 flex items-center justify-between p-6 sm:p-8 border-b border-border/50 bg-muted/10">
                  ...
                  <button onClick={() => setIsModalOpen(false)} className="w-10 h-10 rounded-full flex items-center justify-center bg-transparent border border-border hover:border-red-500 transition-colors text-muted-foreground hover:text-red-500">
                    <X size={18} />
                  </button>
                </div>

                <div className="relative z-30 px-6 sm:px-8 pb-10 pt-8 flex-grow overflow-y-auto flex flex-col">
                  {isSuccess ? (
                    ...
                    <>
                      <p className="text-muted-foreground text-[14px] leading-relaxed mb-8 border-l-2 border-red-600 pl-4 py-1">
                      ...
                      <form onSubmit={handleSubmit} className="flex flex-col gap-8 flex-grow pb-10">
                        ...
                        <button 
                          ...
                          className="mt-auto w-full h-14 flex justify-center items-center gap-3 bg-red-600 hover:bg-red-700 disabled:opacity-50 text-white font-bold text-[13px] uppercase tracking-widest transition-all duration-300 active:scale-[0.98] rounded-xl shadow-lg"
                        >
