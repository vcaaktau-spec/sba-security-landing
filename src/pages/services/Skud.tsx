...
export const Skud = () => {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 2, name: t("service_pages.skud.breadcrumb_current") },
    ],
  }
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    serviceType: t("service_pages.skud.breadcrumb_current"),
    name: t("service_pages.skud.seo_title"),
    description: t("service_pages.skud.seo_desc"),
