...
const includedIcons = [Camera, Server, Wifi, Eye, Shield, Wrench]
const relatedLinks = [
  { to: "/uslugi/skud", icon: Shield },
  { to: "/uslugi/signalizaciya", icon: Star },
...
export const Videonahljudenie = () => {
  ...
  const path = isEn ? "/en/uslugi/videonahljudenie" : "/uslugi/videonahljudenie"
  const homePath = isEn ? "/en" : "/"

  usePageSeo({
    title: t("service_pages.videonabludenie.seo_title"),
  ...
  const steps = t("service_pages.videonabludenie.steps", { returnObjects: true }) as Step[]
  const objectTypes = t("service_pages.videonabludenie.object_types", { returnObjects: true }) as ObjectType[]
  const relatedLabels = t("service_pages.videonabludenie.related", { returnObjects: true }) as string[]
  const related = relatedLinks.map((r, i) => ({ ...r, label: relatedLabels[i] }))
  const stats = t("service_pages.videonabludenie.stats", { returnObjects: true }) as Stat[]
  ...
  return (
    <ServiceLayout>
      ...
      <nav className="max-w-[1200px] mx-auto px-4 sm:px-6 pt-6 flex items-center gap-1.5 text-xs text-muted-foreground/60" aria-label={t("service_pages.common.breadcrumb_nav")}>
        ...
        <ChevronRight size={11} />
        <span className="text-foreground">{t("service_pages.videonabludenie.breadcrumb_current")}</span>
      </nav>
        ...
        >
          <div className="flex items-center gap-2.5 mb-5">
            ...
            <span className="text-[10px] font-mono font-bold uppercase tracking-[0.22em] text-red-600 dark:text-red-500">
              {t("service_pages.videonabludenie.eyebrow")}
            </span>
          </div>

          <h1 className="text-4xl sm:text-5xl lg:text-[3.5rem] font-black tracking-tight leading-[1.08] mb-6 text-foreground">
            {t("service_pages.videonabludenie.h1_line1")}<br />
            <span className="text-red-600 dark:text-red-500">{t("service_pages.videonabludenie.h1_accent")}</span><br />
            {t("service_pages.videonabludenie.h1_line3")}
          </h1>

          <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl mb-8">
            {t("service_pages.videonabludenie.intro")}
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            >
              ...
              {t("service_pages.common.whatsapp_long")}
            </a>
            <a
      ...
      <section className="border-t border-border/30 py-16">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-black tracking-tight mb-10 text-foreground">
            {t("service_pages.common.included_title")}
          </h2>
      ...
      <section className="py-10 border-t border-border/20">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <p className="text-[11px] font-mono font-bold uppercase tracking-widest text-muted-foreground/50 mb-5">
            {t("service_pages.common.equipment_title")}
          </p>
          <div className="flex flex-wrap gap-3">
            {brands.map((b) => (
              <span
      ...
      <section className="border-t border-border/30 py-16">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-black tracking-tight mb-10 text-foreground">
            {t("service_pages.videonabludenie.object_types_title")}
          </h2>
      ...
      <section className="border-t border-border/30 py-16">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-black tracking-tight mb-10 text-foreground">
            {t("service_pages.common.process_title")}
          </h2>
            ...
            <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                <h2 className="text-2xl sm:text-3xl font-black text-white mb-2">
                  {t("service_pages.videonabludenie.cta_title")}
                </h2>
                <p className="text-red-100/80 text-sm">
                  {t("service_pages.videonabludenie.cta_desc")}
                </p>
              </div>
              <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                ...
                >
                  <MessageCircle size={14} />
                  {t("service_pages.common.whatsapp_short")}
                </a>
                <a
                  href="tel:+77779204988"
      ...
      <section className="border-t border-border/30 py-12">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6">
          <p className="text-[11px] font-mono font-bold uppercase tracking-widest text-muted-foreground/50 mb-5">
            {t("service_pages.common.related_title")}
          </p>
          <div className="flex flex-wrap gap-3">
